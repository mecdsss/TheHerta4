...
void main(uint3 dispatchThreadID : SV_DispatchThreadID)
{
    ...
    float grabSpring = SafePositive(PHYS_PARAMS.y, 0.176) * SafePositive(JIGGLE_MULTIPLIERS.w, 1.0);
    float releaseSpring = SafePositive(PHYS_PARAMS.w, 0.055) * SafePositive(JIGGLE_MULTIPLIERS.w, 1.0);
